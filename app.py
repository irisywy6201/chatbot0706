...
CHANNEL_ACCESS_TOKEN='s2IlGTHYdkDQjhLC5pjMmDNfBvU2rj6qFTM8QY87BcajiqBGWeDzcOnet27KcI9cULq0Q0GQTxXTqYjsBuYvWy1/BhQ/ViVQbp7EaCD7CfX4dit3v4RYY6yeWY+WD4lFz6pwrBsReWzC8Q+tF9NTqAdB04t89/1O/w1cDnyilFU='
CHANNEL_SECRET='b8872116a10dba0b0c8d193abbfa6a3f'
...
def handle_message(event):
    ...
    if "空氣" in msg or "PM2.5" in msg:
        ...
        msg_text1 = air_data[5]['SiteName'] + '空氣品質: ' + air_data[0]['Status']
